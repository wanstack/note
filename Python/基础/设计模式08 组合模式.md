...
![image-20210623215311871](images/c9aaf87c75a86010480f8ddc021b402c.png)
...
用[Python](https://so.csdn.net/so/search?q=Python&spm=1001.2101.3001.7020)实现组合模式，需要注意硬盘内存和显示器可能有多个，因此内部需要用列表来进行维护：
