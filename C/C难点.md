...
|                    | 01111111 | 127    |               |               |
|                    | 10000000 | -128   | 特殊值        |               |
|                    | 10000001 | -127   | 反码:11111110 | 原码:11111111 |
|                    | 10000010 | -126   | 反码:11111101 | 原码:11111110 |
|                    | …        | …      |               |               |
|                    | 11111111 | -1     | 反码:10000000 | 原码:10000001 |
...
char a = -128;
printf("%u", a);	// %u表示打印无符号整数
100000000000000000000000010000000	原码
111111111111111111111111101111111	反码
111111111111111111111111110000000	补码

放到 char a中需要截断为补码的低8位
10000000	-a
111111111111111111111111110000000	打印时整型提升
此时打印的时无符号数，则 111111111111111111111111110000000 原码、反码、补码相同，则打印的是111111111111111111111111100000000 十进制数

printf("%d", a);  // 此时打印的是有符号整数，则 111111111111111111111111110000000 数为补码，需要先转换为反码 10000000000000000000000001111111 ，原码为 10000000000000000000000010000000   此时是 -128
